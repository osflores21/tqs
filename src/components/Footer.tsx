import { Anchor, Container, Flex, Group, Image, List, Modal, Text } from '@mantine/core'
...
const Footer = () => {
  const [opened, { open, close }] = useDisclosure(false);
    ...
    // Maneja el bloqueo del scroll del fondo cuando el modal está abierto
    useEffect(() => {
      if (opened) {
      ...
      return () => {
        document.body.style.overflow = '';  // Asegúrate de restaurarlo al desmontarse el componente
      };
    }, [opened]);
  ...
  return (
    <Flex justify={"space-around"} p={"xs"} align={"center"} bg={"#4CC5C4"} >
      ...
      <Modal opened={opened} onClose={close} title="Términos y Condiciones" w={"100%"} size={'xxl'} centered zIndex={1001}>
        <Container >
          <Text fz={18} my={"lg"}>Asistencia Dental</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Revisión y Diagnóstico Dental</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Limpieza Oral Preventiva</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Eliminación de Sarro Visible</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Aplicación Tópica de Flúor</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Consultas con Dentistas de Nuestra Red</Text>
          <Text>
          ...
          <Text fz={18} my={"lg"}>Objetivo de la Limpieza Dental</Text>
          <Text>
          Sin límite de eventos, a precios preferenciales. Los costos de las consultas serán cubiertos por el cliente y pueden variar dependiendo de la zona geográfica y el proveedor. En cualquier otro servicio dental, el usuario podrá obtener precios preferenciales (no acumulables con otras promociones; los costos pueden variar dependiendo del proveedor y la zona geográfica). 
          </Text>
          ...
          <Text fz={18} my={"lg"}>Exclusiones de la Limpieza Oral Preventiva y Sarro Visible</Text>
          <List type="ordered">
